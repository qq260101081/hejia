...
<div class="guarantee-view">
    ...
    <p>
        ...
        <?php if(Yii::$app->user->can('weekly/weekly/update')) echo  Html::a(Yii::t('app', 'Update'), ['update', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
        <?php endif;?>
        <?php if(Yii::$app->user->can('weekly/weekly/delete')) echo Html::a(Yii::t('app', 'Delete'), ['delete', 'id' => $model->id], [
