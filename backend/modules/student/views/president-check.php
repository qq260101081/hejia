...
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'President Weekly List'), 'url' => ['president-index']];
    ...
    <div class="presscentre-form box box-info">
        ...
        <div class="box-body">
            ...
            <div class="box-footer">
                <a href="<?= Url::to(['/student/weekly/president-index']);?>" class="btn btn-info fa fa-reply"></a>
