...
$this->title = Yii::t('app', 'Customer Weekly List'). ':' . $model->student_name;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Customer Weekly List'), 'url' => ['customer-index']];
    ...
    <div class="presscentre-form box box-info">
        ...
        <div class="box-body">
            ...
            <div class="box-footer">
                <a href="<?= Url::to(['/student/weekly/customer-index']);?>" class="btn btn-info fa fa-reply"></a>
