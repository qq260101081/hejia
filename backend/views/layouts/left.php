                ...
                'items' => [
                    ...
                    [
                        ...
                        'items' => [
                            ...
                            ['label' => '周报推送记录', 'icon' => 'fa fa-dot-circle-o', 'active' => Yii::$app->controller->id == 'weekly-push','visible'=> isset($permissions['weekly']['weekly-push']['index']) ? 1 : 0,'url' => ['/weekly/weekly-push/index']],
